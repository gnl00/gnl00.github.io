import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.b41230ea.js";const u=JSON.parse('{"title":"Nginx","description":"Nginx 详解","frontmatter":{"description":"Nginx 详解","tag":["Nginx"]},"headers":[],"relativePath":"posts/devops/Nginx/Nginx.md","filePath":"posts/devops/Nginx/Nginx.md","lastUpdated":1700657743000}'),l={name:"posts/devops/Nginx/Nginx.md"},p=e(`<h1 id="nginx" tabindex="-1">Nginx <a class="header-anchor" href="#nginx" aria-label="Permalink to &quot;Nginx&quot;">​</a></h1><blockquote><p>Nginx（Ngine X），是一个高性能，高可用的Web和方向代理服务器，可用于 HTTP、HTTPS、SMTP、POP3 和 IMAP 协议。它的设计不像传统的服务器一样使用线程处理请求，而是采用事件驱动机制，即一种异步的时间驱动结构。</p></blockquote><br><h2 id="特点" tabindex="-1">特点 <a class="header-anchor" href="#特点" aria-label="Permalink to &quot;特点&quot;">​</a></h2><ul><li>高并发，高性能。Nginx 可以比其他服务器更快地响应请求</li><li>模块化架构，且模块之间耦合度低，使得它的扩展性非常好</li><li>异步非阻塞的事件驱动模型，与 <code>Node.js</code> 类似</li><li>支持热部署、平滑升级，它可以连续几个月甚至更长的时间不需要重启服务器，具有高可靠性</li><li>低内存消耗</li></ul><br><h2 id="操作" tabindex="-1">操作 <a class="header-anchor" href="#操作" aria-label="Permalink to &quot;操作&quot;">​</a></h2><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 启动服务</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 测试配置文件是否正确</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 快速停止或关闭</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 正常停止或关闭</span></span>
<span class="line"><span style="color:#B392F0;">nginx</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">-s</span><span style="color:#E1E4E8;"> </span><span style="color:#9ECBFF;">quit</span></span></code></pre><pre class="shiki github-light vp-code-light"><code><span class="line"><span style="color:#6A737D;"># 启动服务</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#6A737D;"># 正常停止或关闭</span></span>
<span class="line"><span style="color:#6F42C1;">nginx</span><span style="color:#24292E;"> </span><span style="color:#005CC5;">-s</span><span style="color:#24292E;"> </span><span style="color:#032F62;">quit</span></span></code></pre></div><br><h2 id="功能" tabindex="-1">功能 <a class="header-anchor" href="#功能" aria-label="Permalink to &quot;功能&quot;">​</a></h2><h3 id="处理静态资源" tabindex="-1">处理静态资源 <a class="header-anchor" href="#处理静态资源" aria-label="Permalink to &quot;处理静态资源&quot;">​</a></h3><blockquote><p>处理静态资源服务（动静分离），动静分离是指在 Web 服务器架构中，将静态页面与动态页面或者静态内容接口和动态内容接口分开不同系统访问的架构设计方法，进而提升整个服务的访问性和可维护性</p></blockquote><br><p><strong>特点</strong></p><ul><li><p>由于 Nginx 的高并发和静态资源缓存等特性，经常将静态资源部署在 Nginx 上</p></li><li><p>如果请求的是静态资源，直接到静态资源目录获取资源，如果是动态资源的请求，则利用反向代理的原理，把请求转发给对应后台应用去处理，从而实现动静分离</p></li><li><p>使用前后端分离后，可以很大程度提升静态资源的访问速度，即使动态服务不可用，静态资源的访问也不会受到影响</p></li></ul><br><p><strong>配置</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 处理静态资源</span></span>
...
<span class="line"><span style="color:#e1e4e8;">        # 使用 alias 的话路径后必须要加 / ==&gt; /etc/nginx/static/</span></span>
...
<span class="line"><span style="color:#24292e;">        # 使用 alias 的话路径后必须要加 / ==&gt; /etc/nginx/static/</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="正向代理" tabindex="-1">正向代理 <a class="header-anchor" href="#正向代理" aria-label="Permalink to &quot;正向代理&quot;">​</a></h3><blockquote><p>为客户端（用户）代理。意思是一个位于客户端和原始服务器(Origin Server)之间的服务器，为了从原始服务器取得内容，客户端向代理发送一个请求并指定目标(原始服务器)，然后代理向原始服务器转交请求并将获得的内容返回给客户端</p></blockquote><br><p><strong>特点</strong></p><ul><li>正向代理是为用户服务的，即为客户端服务的，客户端可以根据正向代理访问到它本身无法访问到的服务器资源</li><li>正向代理对用户是透明的，对服务端是非透明的，即服务端并不知道自己收到的是来自代理的访问还是来自真实客户端的访问</li></ul><br><h3 id="反向代理" tabindex="-1">反向代理 <a class="header-anchor" href="#反向代理" aria-label="Permalink to &quot;反向代理&quot;">​</a></h3><blockquote><p>为服务器代理，反向代理（Reverse Proxy）方式是指以代理服务器来接受网络上的连接请求，然后将请求转发给内部网络上的服务器，并将从服务器上得到的结果返回给网络上请求连接的客户端，此时代理服务器对外就表现为一个反向代理服务器</p></blockquote><br><p><strong>特点</strong></p><ul><li>反向代理是为服务端服务的，反向代理可以帮助服务器接收来自客户端的请求，帮助服务器做请求转发，负载均衡等</li><li>反向代理对服务端是透明的，对用户是非透明的，即用户并不知道自己访问的是代理服务器，而服务器知道反向代理在为他服务</li><li>优点 <ol><li>隐藏真实服务器</li><li>动静分离，提升系统性能</li><li>负载均衡，便于横向扩充后端动态服务</li></ol></li></ul><br><p><strong>参数</strong></p><p><strong>proxy_pass</strong>，定义在 <code>location</code> 块中，用于配置代理服务器</p><ul><li><p>语法为 <code>proxy_pass URL</code></p></li><li><p><code>URL</code> 必须以 <code>http</code> 或 <code>https</code> 开头</p></li><li><p><code>URL</code> 中可以携带变量</p></li><li><p><code>URL</code> 中是否带 <code>URI</code> ，会直接影响发往上游请求的 <code>URL</code></p></li><li><p>两种常见的 <code>URL</code> 用法</p><ol><li><p><code>proxy_pass http://127.0.0.1:8080</code></p></li><li><p><code>proxy_pass http://127.0.0.1:8080/</code></p></li></ol><p>两种用法的区别就是带 <code>/</code> 和不带 <code>/</code></p><ul><li>不带 <code>/</code>，用户请求 <code>/bbs/abc/test.html</code>，请求到达上游应用服务器的 <code>/bbs/abc/test.html</code></li><li>带 <code>/</code> ，用户请求 <code>/bbs/abc/test.html</code>，请求到达上游应用服务器的 <code>/abc/test.html</code></li></ul></li></ul><p><strong>配置</strong></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 反向代理设置</span></span>
<span class="line"><span style="color:#e1e4e8;">server {</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
<span class="line"><span style="color:#e1e4e8;">    listen       80;</span></span>
...
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="负载均衡" tabindex="-1">负载均衡 <a class="header-anchor" href="#负载均衡" aria-label="Permalink to &quot;负载均衡&quot;">​</a></h3><blockquote><p>当⽤⼾访问⽹站的时候，先访问⼀个中间服务器，再让这个中间服务器根据定制好的负载均衡算法，在服务器集群中选择合适服务器，然后将该访问请求引⼊选择的服务器。⽤⼾每次访问都会保证服务器集群中的每个服务器压⼒趋于平衡，分担了服务器压⼒</p></blockquote><br><p><strong>负载均衡策略</strong></p><ol><li><p>轮询策略</p><p>默认情况下采用的策略，将所有客户端请求轮询分配给服务端</p><p>如果其中某一台服务器压力太大，出现延迟，会影响所有分配在这台服务器下的用户</p></li><li><p><code>ip_hash</code></p><p>来自同一个 IP 的请求永远只分配一台服务器。每个请求按请求 IP 的 hash 结果分配，每个 IP 都能固定访问一个后端的服务器，可以解决 Session 的问题。但 Session 问题不推荐使用 Nginx 解决，推荐 Redis</p></li><li><p>最小连接数策略，将请求优先分配给压力较小的服务器，它可以平衡每个队列的长度，并避免向压力大的服务器添加更多的请求</p></li><li><p>最快响应时间策略，优先分配给响应时间最短的服务器</p></li></ol><br><p><strong>参数</strong></p><p><strong>upstream</strong>，定义在 <code>http</code> 块中，用于定义上游服务器（指的就是后台提供的应用服务器）的相关信息</p><ul><li><code>keepalive</code> 对上游服务启用长连接</li><li><code>keepalive_requests</code> 一个长连接最多请求 HTTP 的个数</li><li><code>keepalive_timeout</code> 空闲情形下，一个长连接的超时时长</li><li><code>hash</code> 哈希负载均衡算法</li><li><code>ip_hash</code> 依据 IP 进行哈希计算的负载均衡算法</li><li><code>least_conn</code> 最少连接数负载均衡算法</li><li><code>least_time</code> 最短响应时间负载均衡算法</li><li><code>random</code> 随机负载均衡算法</li><li><code>server</code> 定义上游服务器地址 <ul><li><code>weight=number</code> 权重值，默认为1</li><li><code>max_conns=number</code> 上游服务器的最大并发连接数</li><li><code>backup</code> 备份服务器，仅当其他服务器都不可用时才会启用</li></ul></li></ul><p><strong>配置</strong></p><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;"># 负载均衡设置一组针对 proxy_pass http://nginx-test.com 服务的负载均衡</span></span>
...
<span class="line"><span style="color:#e1e4e8;">  # weight 配置每个服务器的权重，指定服务器轮询比例，weight 和访问比例成正比，用于后端服务器性能不均的情况</span></span>
...
<span class="line"><span style="color:#24292e;">  # weight 配置每个服务器的权重，指定服务器轮询比例，weight 和访问比例成正比，用于后端服务器性能不均的情况</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="缓存" tabindex="-1">缓存 <a class="header-anchor" href="#缓存" aria-label="Permalink to &quot;缓存&quot;">​</a></h3><blockquote><p>开启缓存可以存储一些之前被访问过、而且可能将要被再次访问的资源，使用户可以直接从代理服务器获得，从而减少上游服务器的压力</p></blockquote><br><p><strong>参数</strong></p><ul><li><strong>proxy_cache</strong>，定义在 <code>location</code> 块中，存储一些之前被访问过，且可能会被再次访问的资源，可以直接从代理服务器获得，减少上游服务器的压力，加快整个访问速度 <ul><li><code>proxy_cache zone | off </code>，zone 是共享内存的名称</li><li>默认值 <code>off</code></li></ul></li><li>proxy_cache_path，设置缓存文件的存放路径</li><li>proxy_cache_key，设置缓存文件的 <code>key</code></li><li>proxy_cache_valid，配置什么状态码可以被缓存，以及缓存时长</li></ul><p><strong>配置</strong></p><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
<span class="line"><span style="color:#e1e4e8;">  listen 80;</span></span>
<span class="line"><span style="color:#e1e4e8;">  server_name localhost;</span></span>
<span class="line"><span style="color:#e1e4e8;">  location / {</span></span>
<span class="line"><span style="color:#e1e4e8;">    proxy_cache cache_zone; # 设置缓存内存</span></span>
<span class="line"><span style="color:#e1e4e8;">    proxy_cache_valid 200 5m; # 缓存状态为 200 的请求，缓存时长为 5 分钟</span></span>
<span class="line"><span style="color:#e1e4e8;">    proxy_cache_key $request_uri; # 缓存文件的 key 为请求的 URI</span></span>
...
<span class="line"><span style="color:#24292e;">    proxy_cache_valid 200 5m; # 缓存状态为 200 的请求，缓存时长为 5 分钟</span></span>
<span class="line"><span style="color:#24292e;">    proxy_cache_key $request_uri; # 缓存文件的 key 为请求的 URI</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="限流" tabindex="-1">限流 <a class="header-anchor" href="#限流" aria-label="Permalink to &quot;限流&quot;">​</a></h3><blockquote><p>Nginx的限流模块，是基于漏桶算法实现的，在⾼并发的场景下⾮常实⽤</p></blockquote><br><p><strong>参数</strong></p><ul><li><strong>limit_req_zone</strong>，定义在 <code>http</code> 块中，</li><li>zone，<code>zone = ip状态:共享内存区域</code>，定义IP状态及URL访问频率的共享内存区域，<code>zone=keyword</code> 标识区域的名字，以及冒号后⾯跟区域⼤⼩</li><li>rate，定义最⼤请求速率</li></ul><p><strong>配置</strong></p><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">http {</span></span>
<span class="line"><span style="color:#e1e4e8;">    # $binary_remote_addr 表⽰保存客⼾端 IP 地址的⼆进制形式</span></span>
<span class="line"><span style="color:#e1e4e8;">    # mylimit zone=keyword 标识区域的名字</span></span>
<span class="line"><span style="color:#e1e4e8;">    # 10m 16000 个 IP 地址的状态信息约 1MB，所以⽰例中 10m 区域可以存储 160000 个 IP 地址</span></span>
<span class="line"><span style="color:#e1e4e8;">    # rate=100r/s 速率不能超过每秒 100 个请求</span></span>
...
<span class="line"><span style="color:#24292e;">    # $binary_remote_addr 表⽰保存客⼾端 IP 地址的⼆进制形式</span></span>
<span class="line"><span style="color:#24292e;">    # mylimit zone=keyword 标识区域的名字</span></span>
<span class="line"><span style="color:#24292e;">    # 10m 16000 个 IP 地址的状态信息约 1MB，所以⽰例中 10m 区域可以存储 160000 个 IP 地址</span></span>
<span class="line"><span style="color:#24292e;">    # rate=100r/s 速率不能超过每秒 100 个请求</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;"></span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="黑白名单" tabindex="-1">黑白名单 <a class="header-anchor" href="#黑白名单" aria-label="Permalink to &quot;黑白名单&quot;">​</a></h3><blockquote><p>可以拒绝某个（某组）IP访问</p></blockquote><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">location / {</span></span>
...
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="https" tabindex="-1">HTTPS <a class="header-anchor" href="#https" aria-label="Permalink to &quot;HTTPS&quot;">​</a></h3><blockquote><p>使用Nginx配置HTTPS支持</p></blockquote><br><p><strong>HTTPS工作流程</strong></p><ol><li>客户端（浏览器）访问 <code>https://www.baidu.com</code> 百度网站；</li><li>百度服务器返回 HTTPS 使用的 CA 证书；</li><li>浏览器验证 CA 证书是否合法；</li><li>验证通过，证书合法，生成一串随机数并使用公钥（证书中提供的）进行加密；</li><li>发送公钥加密后的随机数给百度服务器；</li><li>百度服务器拿到密文，通过私钥进行解密，获取到随机数（公钥加密，私钥解密，反之也可以）；</li><li>百度服务器把要发送给浏览器的内容，使用随机数进行加密后传输给浏览器；</li><li>此时浏览器可以使用公钥进行解密，获取到服务器的真实传输内容；</li></ol><p>这就是 HTTPS 的基本运作原理，对称加密和非对称加密配合使用，保证传输内容的安全性</p><p><strong>配置证书</strong></p><p>下载 HTTPS 证书的压缩文件，里面有个 Nginx 文件夹，把 <code>xxx.crt</code> 和 <code>xxx.key</code> 文件拷贝到服务器目录，再进行配置</p><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
...
<span class="line"><span style="color:#e1e4e8;">  ssl_protocols TLSv1 TLSv1.1 TLSv1.2; # 支持 ssl 协议版本，默认为后三个，主流版本是[TLSv1.2]</span></span>
<span class="line"><span style="color:#e1e4e8;"> </span></span>
<span class="line"><span style="color:#e1e4e8;">  location / {</span></span>
...
<span class="line"><span style="color:#24292e;">  ssl_protocols TLSv1 TLSv1.1 TLSv1.2; # 支持 ssl 协议版本，默认为后三个，主流版本是[TLSv1.2]</span></span>
<span class="line"><span style="color:#24292e;"> </span></span>
<span class="line"><span style="color:#24292e;">  location / {</span></span>
...
<span class="line"><span style="color:#24292e;">  }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div><br><h3 id="跨域访问" tabindex="-1">跨域访问 <a class="header-anchor" href="#跨域访问" aria-label="Permalink to &quot;跨域访问&quot;">​</a></h3><blockquote><p>跨域，通过不同 IP 或端口进行资源访问</p></blockquote><p><strong>配置</strong></p><p>如</p><ul><li>前端服务为 <code>fronten.server.com</code>，后端服务为 <code>backen.server.com</code></li></ul><div class="language-conf vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">conf</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">server {</span></span>
<span class="line"><span style="color:#e1e4e8;">    listen 80;</span></span>
...
<span class="line"><span style="color:#24292e;">    }</span></span>
<span class="line"><span style="color:#24292e;">}</span></span></code></pre></div>`,86),o=[p];function c(t,i,r,y,d,h){return n(),a("div",null,o)}const b=s(l,[["render",c]]);export{u as __pageData,b as default};
