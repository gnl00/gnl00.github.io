import{_ as s,o as a,c as n,Q as l}from"./chunks/framework.519d889f.js";const u=JSON.parse('{"title":"Docker","description":"Docker 详解","frontmatter":{"description":"Docker 详解","tag":["Docker","DevOps"]},"headers":[],"relativePath":"posts/devops/Docker/Docker.md","filePath":"posts/devops/Docker/Docker.md","lastUpdated":1699262313000}'),p={name:"posts/devops/Docker/Docker.md"},o=l(`<h1 id="docker" tabindex="-1">Docker <a class="header-anchor" href="#docker" aria-label="Permalink to &quot;Docker&quot;">​</a></h1><h2 id="安装-docker" tabindex="-1">安装 Docker <a class="header-anchor" href="#安装-docker" aria-label="Permalink to &quot;安装 Docker&quot;">​</a></h2><blockquote><p>Windows 先安装 WSL2，再安装 Docker。</p></blockquote><blockquote><p>镜像加速与修改镜像源：</p><ul><li><a href="https://cr.console.aliyun.com/cn-hangzhou/instances/mirrors" target="_blank" rel="noreferrer">阿里云服务器设置 Docker 镜像加速器</a></li><li><a href="https://blog.csdn.net/m0_37886429/article/details/80323149" target="_blank" rel="noreferrer">更改docker仓库源地址 1</a></li><li><a href="https://www.jianshu.com/p/df75f9b5fcf6" target="_blank" rel="noreferrer">更改docker仓库源地址 2</a></li></ul></blockquote><p><strong>安装完成启动</strong></p><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># ubuntu</span></span>
