import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.b41230ea.js";const h=JSON.parse('{"title":"Node.js","description":"Node.js 笔记","frontmatter":{"description":"Node.js 笔记","tag":["前端"]},"headers":[],"relativePath":"posts/fe/Node.js/Node.js.md","filePath":"posts/fe/Node.js/Node.js.md","lastUpdated":1700657743000}'),p={name:"posts/fe/Node.js/Node.js.md"},o=l(`<h1 id="node-js" tabindex="-1">Node.js <a class="header-anchor" href="#node-js" aria-label="Permalink to &quot;Node.js&quot;">​</a></h1><h2 id="开始" tabindex="-1">开始 <a class="header-anchor" href="#开始" aria-label="Permalink to &quot;开始&quot;">​</a></h2><h3 id="安装" tabindex="-1">安装 <a class="header-anchor" href="#安装" aria-label="Permalink to &quot;安装&quot;">​</a></h3><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;"># 安装</span></span>
