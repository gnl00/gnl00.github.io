import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.b41230ea.js";const u=JSON.parse('{"title":"前端项目配置","description":"前端项目配置","frontmatter":{"description":"前端项目配置","tag":["前端"]},"headers":[],"relativePath":"posts/fe/项目配置.md","filePath":"posts/fe/项目配置.md","lastUpdated":1700722361000}'),p={name:"posts/fe/项目配置.md"},o=l(`<h1 id="前端项目配置" tabindex="-1">前端项目配置 <a class="header-anchor" href="#前端项目配置" aria-label="Permalink to &quot;前端项目配置&quot;">​</a></h1><h2 id="eslint" tabindex="-1">ESLint <a class="header-anchor" href="#eslint" aria-label="Permalink to &quot;ESLint&quot;">​</a></h2><h3 id="开发中关闭eslint检查" tabindex="-1">开发中关闭ESLint检查 <a class="header-anchor" href="#开发中关闭eslint检查" aria-label="Permalink to &quot;开发中关闭ESLint检查&quot;">​</a></h3><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// 1、修改 .eslintrc.js</span></span>
